  ...
  render() {
    ...
    let roomForm = (
        ...
        <form onSubmit={this.createRoom}>
          ...
          <input  className= "insertRoom" type="text" value={this.state.name} placeholder="Create room" onChange={this.roomChange} />
          <input className= "SubmitRoom" type="submit" value="Submit"/>
        </form>
